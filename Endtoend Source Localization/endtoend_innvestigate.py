...
# Load dataset
filename = '/nas/home/amontali/data_endtoend/T60_0.2_SNR_20_test3.tfrecord'
test_dataset = create_endtoend_dataset(filepath=filename, buffer_size=300)
eval_dataset = test_dataset.repeat().batch(100)
'''
filename = '/nas/home/amontali/data_endtoend/T60_0.2_SNR_20_LROOM.tfrecord'
...
plt.ylabel('RMSE')
plt.legend()
plt.title('TRAIN: T60 = 0.5 s | SNR = 20 dB, TEST: T60 = 0.5 s | SNR = 20 dB | Large Room')
plt.show()
