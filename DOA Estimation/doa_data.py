...
parser.add_argument('--filename', type=str, help='filename', default='/nas/home/amontali')
parser.add_argument('--dataset_type', type=str, help='dataset_type', default='train')
parser.add_argument('--data_type', type=str, help='data_type', default='noise')
...
SNR = 20
if data_type == 'noise':
    filename = '/nas/home/amontali/data_doa/noise_T60_0.2_SNR_20_test.tfrecord'
else:
    filename = '/nas/home/amontali/data_doa/speech_T60_0.2_SNR_20_train.tfrecord'
'''
...
# mic_center = np.array([1.7, 7.0, 0.92])
mic_center = np.array([1.8, 6.2, 0.92])
...
# Specify data_type, reverberation and signal-to-noise-ratio
data_type = 'noise'
T60 = 0.3
SNR = 10
...
if data_type == 'noise':
    filename = '/nas/home/amontali/data_doa/noise_T60_0.3_SNR_10.tfrecord'
else:
    filename = '/nas/home/amontali/data_doa/speech_T60_0.3_SNR_10.tfrecord'
